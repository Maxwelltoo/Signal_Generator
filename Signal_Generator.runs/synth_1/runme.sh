...
HD_PWD='D:/FPGA/Project/Vivado/Signal_Generator/Signal_Generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Signal_Generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Signal_Generator.tcl
