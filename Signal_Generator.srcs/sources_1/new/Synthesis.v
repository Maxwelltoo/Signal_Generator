...
always @(posedge clk) acc <= acc + f_word;

reg [31:0] dds_cos_sin;
dds_compiler_0 sin_wave (clk, dac_pre, {p_word,f_word}, valid, dds_cos_sin); 
wire [11:0] sin  = dds_cos_sin[11:0];
wire [11:0] tria = (acc[15:4]) + p_word;
wire [11:0] rect = (acc[15] ? 12'h000:12'hfff) + p_word;
wire [11:0] swat = (acc[15] ? acc[14:3]:~acc[14:3]) + p_word;
